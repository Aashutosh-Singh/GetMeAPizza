    ...
    <>
      <div className="mb-15">
        <div className="flex flex-col justify-center items-center gap-2 my-4">
          <div className="flex justify-center gap-2 items-center px-6">
            <img src="/buymeapizza.png" alt="Buy me a pizza" className="sm:h-60 h-28 md:h-80 lg:h-100 " />
            <img src="/pizza.png" alt="Pizza" className="sm:h-60 h-28  lg:h-80 " />
          </div>
          
          <div className="flex flex-col gap-6 items-center text-center px-6">
            <p>
              A crowdfunding platform for <i>Individuals</i>. Get funded by your fans and followers. Start now!
            </p>
            ...
            <div className="relative group inline">
              <button className="relative text-white inline-block p-px font-semibold leading-6 bg-gray-800 shadow-2xl cursor-pointer rounded-xl shadow-zinc-600 transition-transform duration-300 ease-in-out hover:scale-105 active:scale-95">
                <span className="absolute inset-0 rounded-xl bg-gradient-to-r from-teal-400 via-blue-500 to-purple-500 p-[2px] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
